    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='default/default_user.png', upload_to='user_avatars')),
        ...
        migrations.AddField(
            model_name='order',
            name='shipping',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='store.shippingaddress'),
        ),
    ]
